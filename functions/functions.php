...
if (!function_exists('mv_slider_get_placeholder_image')) {
    ...
    {
        return "<img src='" . MV_SLIDER_URL . "assets/images/default.jpg' alt='placeholder image'
...
if (!function_exists('mv_slider_options')) {
    function mv_slider_options()
    {
        ...
        wp_enqueue_script('mv-slider-main-js', MV_SLIDER_URL . 'vendor/flexslider/flexslider.js', array('jquery'), MV_SLIDER_VERSION, true);
        wp_localize_script(
            'mv-slider-main-js',
            'SLIDER_OPTIONS',
            array(
